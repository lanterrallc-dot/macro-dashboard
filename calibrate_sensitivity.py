...
PAIRS = [
    ...
    {'metric': 'Broad Dollar Index (DXY)', 'series': 'DTWEXBGS', 'ticker': 'UUP',
     'note': "DXY level vs. the Dollar's own ETF — this one SHOULD show a strong positive relationship almost "
             "by construction (UUP tracks the dollar), useful as a sanity check on the whole method"},
    {'metric': 'Fed Balance Sheet', 'series': 'WALCL', 'ticker': 'QQQ',
     'note': 'Fed balance sheet size vs. the most liquidity-sensitive mapped asset (Nasdaq/Growth)'},
    {'metric': 'Bank Reserves', 'series': 'WRESBAL', 'ticker': 'QQQ',
     'note': 'Bank reserves level vs. Nasdaq/Growth — reserves falling has historically meant tighter liquidity'},
    {'metric': 'Treasury General Account', 'series': 'WTREGEN', 'ticker': 'QQQ',
     'note': 'TGA balance vs. Nasdaq/Growth — TGA rising pulls cash OUT of the banking system'},
    {'metric': 'VIX', 'series': 'VIXCLS', 'ticker': 'SPY',
     'note': 'VIX level vs. S&P 500 — VIX is literally derived from S&P options, so some relationship here is close to definitional'},
    {'metric': 'Financial Conditions (NFCI)', 'series': 'NFCI', 'ticker': 'SPY',
     "note": "Chicago Fed's financial conditions index vs. S&P 500"},
]
